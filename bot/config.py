...
WEATHER_TIMEOUT_SECONDS = _positive_float_env("WEATHER_TIMEOUT_SECONDS", 8)
WEATHER_CACHE_TTL_SECONDS = _positive_int_env("WEATHER_CACHE_TTL_SECONDS", 1800)
AIESA_API_PUBLIC = os.getenv("AIESA_API_PUBLIC", "").strip()
AIESA_API_SECRET = os.getenv("AIESA_API_SECRET", "").strip()
AIESA_TRANSCRIPTION_POLL_SECONDS = _positive_int_env("AIESA_TRANSCRIPTION_POLL_SECONDS", 15)
AI_TRANSCRIPTION_PROVIDER_READ_TIMEOUT_SECONDS = _positive_float_env(
    "AI_TRANSCRIPTION_PROVIDER_READ_TIMEOUT_SECONDS", 3600)
AI_TRANSCRIPTION_UPLOAD_TIMEOUT_SECONDS = _positive_float_env(
    "AI_TRANSCRIPTION_UPLOAD_TIMEOUT_SECONDS", 600)
AI_TRANSCRIPTION_MAX_FILE_BYTES = _positive_int_env("AI_TRANSCRIPTION_MAX_FILE_MB", 50) * 1024 * 1024
AI_TRANSCRIPTION_CLEANUP_MODEL = os.getenv("AI_TRANSCRIPTION_CLEANUP_MODEL", os.getenv("POLZA_AI_MODEL", "")).strip()
POLZA_TRANSCRIPTION_MODEL = os.getenv("POLZA_TRANSCRIPTION_MODEL", "openai/gpt-4o-mini-transcribe").strip()
